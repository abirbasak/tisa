...
namespace azuik
{
    namespace core
    {
        ...
        {
            template <class InIter, enable_if<core::is_trivially_destructible<core::value_type<InIter>>, int> = 0>
            void operator()(InIter, InIter) const noexcept
            {
            }
            template <class InIter,
                      core::disable_if<core::is_trivially_destructible<core::value_type<InIter>>, int> = 0>
